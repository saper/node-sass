...
module.exports.render = function(options, cb) {
  ...
  return options.hasOwnProperty('data') ? binding.render(options) : binding.renderFile(options);
};
...
module.exports.renderSync = function(options) {
  ...
  var status = options.hasOwnProperty('data') ? binding.renderSync(options) : binding.renderFileSync(options);
  var result = options.result;
